  ...
  <q-page class="projects-page q-pa-md">
    ...
    <div class="row q-gutter-xs q-mb-sm no-wrap gt-sm">
      ...
      <div class="col">
        ...
        >
          <q-card-section class="q-pa-xs text-center">
            <div class="text-subtitle2 text-blue q-mb-none">
              {{ totalPlanning }}
            </div>
      ...
      <div class="col">
        ...
        >
          <q-card-section class="q-pa-xs text-center">
            <div class="text-subtitle2 text-green q-mb-none">
              {{ totalActive }}
            </div>
      ...
      <div class="col">
        ...
        >
          <q-card-section class="q-pa-xs text-center">
            <div class="text-subtitle2 text-orange q-mb-none">
              {{ totalOnHold }}
            </div>
      ...
      <div class="col">
        ...
        >
          <q-card-section class="q-pa-xs text-center">
            <div class="text-subtitle2 text-purple q-mb-none">
              {{ totalCompleted }}
            </div>
      ...
      <div class="col">
        ...
        >
          <q-card-section class="q-pa-xs text-center">
            <div class="text-subtitle2 text-red q-mb-none">
              {{ totalCancelled }}
            </div>
          ...
          <q-tr :props="props">
            ...
            <q-td key="budget" :props="props">
              <div class="text-right">
                ...
                <div
                  v-if="props.row.budget_allocated"
              ...
              >
                <div class="q-pa-md">
                  <div class="row q-col-gutter-md">
                    ...
                    <div
                      v-if="
                        props.row.budget_allocated || props.row.budget_spent
                      "
                      ...
                      <div class="text-body2">
                        ...
                        <div v-if="props.row.budget_allocated">
                          <strong>Remaining:</strong> ${{
                            formatCurrency(
                              props.row.budget_allocated -
                                (props.row.budget_spent || 0)
                            )
                          }}
                        </div>
                      </div>
          ...
          <div class="q-pa-xs col-xs-12 col-sm-6 col-md-4">
            <q-card>
              <q-card-section>
                ...
                <!-- Budget info -->
                <div
                  v-if="props.row.budget_allocated || props.row.budget_spent"
                  class="q-mt-sm"
                >
      ...
      >
        ...
        >
          <q-card-section>
            ...
            <!-- Budget Info -->
            <div
              v-if="project.budget_allocated || project.budget_spent"
    ...
    <q-dialog v-model="showReportsDialog" persistent max-width="900px">
      <ProjectReports @close="showReportsDialog = false" />
    </q-dialog>
  </q-page>
</template>
  ...
  const loadProjects = async () => {
    ...
    try {
      const params = {
        ...
        offset:
          (tablePagination.value.page - 1) * tablePagination.value.rowsPerPage,
